    ...
    <div className="trade-item m-1">
      <div className="trade-img">
        ...
        <div className="subimg1 row">
          <img className={item.name.length>14?"moveUpImg":""} src="/images/item_2.svg" alt="item_2.svg" />
          <h6 className={item.name.length>14?"moveUpLetter":""}>58</h6>
        </div>
        <div className="subimg2">
          <img src="/images/item_3.svg" alt="item_3.svg" />
        </div>
      </div>
      <div className={item.name.length>14?"item-text moveUp":"item-text"} >
        {item.name.length>20?
        <h6 className="item-text" style={{ fontSize: "12px" }} >{ item.name.slice(0, 20) }...</h6>
        :
        <h6 className="item-text" style={{ fontSize: "12px" }} >{ item.name }</h6>
        }
      </div>
    </div>
  );
